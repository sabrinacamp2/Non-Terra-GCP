...
1. Creating a VM instance and attaching a persistent disk through the GCP UI
	1. Ask Brendan and Erin to create a google cloud project for you (e.g. `vanallen-scamp` is mine). You will receive an email to accept the project invitation where you will click the link provided. Then, the project should show up when you navigate to the [Google Cloud Console](https://console.cloud.google.com/ )and log in. <br>   ![mainpage](Attachments/Pasted image 20230718164316.png)
...
1. [Option two, Sabrina preferred] Jupyter lab ^f0c684
...
4. [Mount persistent disk to VM](#^8fc414) 
5. [Allow docker user to read/write to PD](#^f97532)
